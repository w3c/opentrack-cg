...
* [Athletics Conceptual Model](https://w3c-cg.github.io/opentrack-cg/spec/model/)
* [Competition Data Model and Vocabulary](https://w3c-cg.github.io/opentrack-cg/spec/competition/) based on Schema.org
* [Sports Competition Digital Credentials Use Cases](https://w3c-cg.github.io/opentrack-cg/spec/credentials-uc/) (status: working draft)
...
Read the [Charter](https://w3c-cg.github.io/opentrack-cg/charter.html) for more information about this group.
...
* A **[Conceptual Data Model for Athletics](https://w3c-cg.github.io/opentrack-cg/spec/model/)** to define Athletics competitions, events, management and participation in an abstract way; and
* a **[Sports Competition Data Model and Vocabulary](https://w3c-cg.github.io/opentrack-cg/spec/competition/)** based on Schema.org. It contains examples of implementation for competitions, participation, athletes, organizations, etc.
